...
const Booking = () => {
  return (
    <section class="w-full flex items-center justify-center p-4 sm:p-14 ">
      <div class=" sm:w-[500px] w-full bg-myblue rounded-lg py-5 px-10 shadow-booking flex-col justify-center items-center">
        <div class="text-white text-left font-semibold text-lg justify-center">
